...
//Sentence includes information of one couple equivalent Vi-En sentense
...
type Conversation struct {
	Title                string
	Description          string
	ConversationSentences []ConversationSentense
}
...
type ConversationSentense struct {
	...
	Sentence string
	Mean     string // Mean of sentence, maybe empty
}
